...
(() => {
  ...
  function d(n, t) {
    if (!t) return n && n.then ? n.then(l) : Promise.resolve();
  }
  var p = (function (n) {
    var t, e;
    function o(t, e) {
      ...
      return (
        ...
        (r.ln = function (n) {
          var t = r.fn,
            ...
            o = e.state,
            a = e === r.vn,
            i = { sw: e, isExternal: a, originalEvent: n };
          !a && r.mn && (i.isUpdate = !0),
            ...
            "installed" === o
              ? (r.wn = self.setTimeout(function () {
                  "installed" === o &&
                    t.waiting === e &&
                    r.dispatchEvent(new s("waiting", i));
                }, 200))
              : "activating" === o &&
    ...
    return (
      ...
      (l.messageSW = function (n) {
        try {
          return u(this.getSW(), function (t) {
            return r(t, n);
          });
        } catch (n) {
          return Promise.reject(n);
      ...
      (l.messageSkipWaiting = function () {
        this.fn && this.fn.waiting && r(this.fn.waiting, f);
      }),
      (l.pn = function () {
    ...
    (function () {
      ...
      return (
        ...
        (t.dispatchEvent = function (n) {
          n.target = this;
          for (var t, e = a(this.Sn(n.type)); !(t = e()).done; )
            (0, t.value)(n);
        }),
        (t.Sn = function (n) {
  ...
  const h = (n, t) => t.some((t) => n instanceof t);
  let v, y;
  const g = new WeakMap(),
    m = new WeakMap(),
    b = new WeakMap(),
  ...
  let k = {
    get(n, t, e) {
      if (n instanceof IDBTransaction) {
        if ("done" === t) return m.get(n);
        if ("objectStoreNames" === t) return n.objectStoreNames || b.get(n);
        if ("store" === t)
    ...
    return "function" == typeof n
      ? (t = n) !== IDBDatabase.prototype.transaction ||
        ...
        ? (
          ...
          ? function (...n) {
              return t.apply(j(this), n), S(g.get(this));
            }
          : function (...n) {
              return S(t.apply(j(this), n));
            }
        : function (n, ...e) {
            const r = t.call(j(this), n, ...e);
            return b.set(r, n.sort ? n.sort() : [n]), S(r);
          }
          ...
          (function (n) {
            ...
            const t = new Promise((t, e) => {
              const r = () => {
                ...
                a = () => {
                  e(n.error || new DOMException("AbortError", "AbortError")),
                    r();
                };
  ...
  function S(n) {
    ...
    const t = E(n);
    return t !== n && (w.set(n, t), x.set(t, n)), t;
  }
  const j = (n) => x.get(n);
  function L(
    n,
    ...
    return (
      r &&
        i.addEventListener("upgradeneeded", (n) => {
          r(S(i.result), n.oldVersion, n.newVersion, S(i.transaction));
        }),
  ...
  function M() {
    ...
    function l(n, t, e, r) {
      var a = t && t.prototype instanceof g ? t : g,
        ...
        c = new T(r || []);
      return o(i, "_invoke", { value: j(n, e, c) }), i;
    }
    function f(n, t, e) {
      try {
      ...
      (t.mark = function (n) {
        return (
          Object.setPrototypeOf
            ...
            : ((n.__proto__ = b), u(n, s, "GeneratorFunction")),
  ...
  (C = k),
    (k = {
      ...C,
      get: (n, t, e) => O(n, t) || C.get(n, t, e),
      has: (n, t) => !!O(n, t) || C.has(n, t),
    });
  var N = (function () {
      var n = B(
        M().mark(function n() {
            ...
            for (;;)
              switch ((n.prev = n.next)) {
                ...
                case 9:
                  return (
                    (a = n.sent),
                    console.log("🚀 - data retrieved from the database", a),
                    n.abrupt("return", a)
                  );
                case 12:
                case "end":
  ...
  function G(n, t) {
    for (var e = 0; e < t.length; e++) {
      ...
      (r.enumerable = r.enumerable || !1),
        (r.configurable = !0),
        "value" in r && (r.writable = !0),
        Object.defineProperty(n, z(r.key), r);
    }
  }
  function R(n, t, e) {
    return (
  ...
  var q = R(function n() {
    ...
    rn = e(16),
    on = {};
  (on.styleTagTransform = en()),
    (on.setAttributes = X()),
    (on.insert = J().bind(null, "head")),
    (on.domAPI = Y()),
    (on.insertStyleElement = nn()),
    K()(rn.A, on),
    rn.A && rn.A.locals && rn.A.locals;
  var an,
    cn = document.querySelector("#main");
  (cn.innerHTML = ""),
    void 0 === new q() &&
      ((an = document.createElement("div")).classList.add("spinner"),
      (an.innerHTML =
